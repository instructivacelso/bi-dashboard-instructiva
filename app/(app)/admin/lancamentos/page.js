    ...
    <>
      ...
      {lancs.length === 0 ? <Vazio>Nenhum lançamento cadastrado.</Vazio> : (
        <div className="painel tabela-wrap"><table>
          <thead><tr><th>Lançamento</th><th>Fase</th><th>Captação</th><th>Live</th><th className="num">Orçamento</th><th className="num">Meta cadastros</th><th className="num">Equipe</th></tr></thead>
          <tbody>{lancs.map((l) => (
            <tr key={l.id}>
