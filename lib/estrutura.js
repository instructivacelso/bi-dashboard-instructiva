...
export const SETORES = [
  ...
  { slug: 'rh', nome: 'RH', descricao: 'Pessoas: quadro, admissões, desligamentos, ponto, recrutamento, treinamentos e custo de pessoal.', modulo_ativo: true, ordem: 5 },
  { slug: 'suporte', nome: 'Suporte', descricao: 'Atendimento ao aluno após o onboarding.', modulo_ativo: true, ordem: 6 },
  { slug: 'pos-venda', nome: 'Pós-venda', descricao: 'Retenção e renovação: onboarding, acompanhamento, renovações, cancelamentos, upsell e satisfação do aluno.', modulo_ativo: true, ordem: 7 },
  ...
  { slug: 'academico', nome: 'Professores e Acadêmico', descricao: 'Produtividade dos professores: gravações, criativos, materiais, suporte, lives, vendas e pipeline de conteúdo.', modulo_ativo: true, ordem: 10 },
];
...
export const SUBSETORES_OUTROS = {
  ...
  rh: [{ slug: 'operacao', nome: 'Operação de RH', ordem: 1, formulario: 'rh_fechamento' }, { slug: 'gerencia', nome: 'Gerente de RH', ordem: 2 }],
  academico: [{ slug: 'professores', nome: 'Professores', ordem: 1, formulario: 'professor_diario' }, { slug: 'coordenacao', nome: 'Coordenação acadêmica', ordem: 2 }],
  'pos-venda': [{ slug: 'operacao', nome: 'Operação de pós-venda', ordem: 1, formulario: 'posvenda_fechamento' }, { slug: 'gerencia', nome: 'Gerente de pós-venda', ordem: 2 }],
};
