...
export const SUBSETORES_OUTROS = {
  ...
  indicacoes: [{ slug: 'vendas', nome: 'Vendas por indicação', ordem: 1 }, { slug: 'coleta', nome: 'Coleta de indicações', ordem: 2 }, { slug: 'gerencia', nome: 'Gerente de Indicação', ordem: 3, formulario: 'indicacao_gerente' }],
