...
export const SETORES = [
  ...
  { slug: 'comercial-diretoria', nome: 'Comercial — Diretoria', descricao: 'Diretoria comercial: visão dos dois times.', modulo_ativo: false, ordem: 3 },
...
export const SUBSETORES_OUTROS = {
  'comercial-jesuitas': [{ slug: 'vendedores', nome: 'Vendedores', ordem: 1 }, { slug: 'gerente', nome: 'Gerente comercial', ordem: 2 }],
  'comercial-toledo': [{ slug: 'vendedores', nome: 'Vendedores', ordem: 1 }, { slug: 'gerente', nome: 'Gerente comercial', ordem: 2 }],
